...
apply('grandhotel.x',{img:'https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&w=2200&q=88',tag:'A grand digital address for luxury hospitality',ideas:['Build a premium hotel booking or luxury accommodation platform around the elegant GrandHotel.x name.','Use GrandHotel.x as the flagship digital identity for an independent hotel, resort group or hospitality brand.','Create a high-end travel, concierge or last-minute luxury stay marketplace around a name that immediately signals hospitality.']});

console.log('Session overrides, price repair and GrandHotel fix applied.');
